...
'✅ CLIENT-SIDE PRIVACY LOCK: Lấy ConversationKey (plaintext) từ backend. Yêu cầu user phải là member của conversation. Trả về conversation_key dạng base64 string.';
