-- Setup Call System Database
-- Chạy script này trong Supabase SQL Editor

-- 1. Tạo bảng call_requests
...
-- 8. Tạo function để tự động tạo call_history
...
-- INSERT INTO call_requests (caller_id, receiver_id, conversation_id, call_type, status)
-- VALUES ('user1-id', 'user2-id', 'conversation-id', 'voice', 'ringing');
